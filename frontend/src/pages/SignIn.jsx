    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 -left-32 w-80 h-80 bg-amber-500/10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-1/4 -right-32 w-80 h-80 bg-orange-500/10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-md space-y-8 animate-fade-in">
                <div className="text-center">
                    ...
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-amber-200 to-orange-300 bg-clip-text text-transparent">Welcome back</h1>
                    <p className="text-amber-100/50 mt-2">Sign in to continue your conversations</p>
                </div>
                ...
                <p className="text-center text-amber-200/50">
                    ...
                    <Link to="/signup" className="text-amber-300 hover:text-amber-200 hover:underline transition-colors">
                        Sign up
                    </Link>
                </p>
            </div>
